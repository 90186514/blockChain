...
#define XHHTuanNumViewHight 153
#define XHHTuanNumViewWidth 306
@interface PhotoDeleteTipPopUpView()<UIGestureRecognizerDelegate>
...
@implementation PhotoDeleteTipPopUpView
...
//        [_contentView addSubview:closeBtn];
        ...
        saftBtn.frame = CGRectMake(0, 29, _contentView.width, 47);
...
- (void)richElementsInViewWithModel:(id)model{
    [_saftBtn setTitle:[NSString stringWithFormat:@"%@",model] forState:UIControlStateNormal];
